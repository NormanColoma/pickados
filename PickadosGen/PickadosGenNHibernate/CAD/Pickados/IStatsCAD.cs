...
System.Collections.Generic.IList<PickadosGenNHibernate.EN.Pickados.StatsEN> GetStatsByMonthTipster (string p_Tipster_Name, PickadosGenNHibernate.Enumerated.Pickados.MonthsEnum? p_Stats_Month, int ? p_Stats_Year);
}
}
